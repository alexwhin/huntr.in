...
var defaultSettings = {
  ...
  serverURL:  true ? 'http://192.168.0.68:3000/' : 'https://huntr.in/',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__includes_stylesheet__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__includes_widget_markup__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__settings__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__widget_size__ = __webpack_require__(49);
  ...
  _createClass(WidgetSize, [{
    ...
    value: function widgetSize() {
      ...
      if (contentHeight < 10) {
        ...
        if (contentHeight > __WEBPACK_IMPORTED_MODULE_0__settings__["a" /* settings */].widgetHeight) contentHeight = __WEBPACK_IMPORTED_MODULE_0__settings__["a" /* settings */].widgetHeight;
        if (contentHeight < 320) contentHeight = 312;
        if (windowHeight < 425) contentHeight = 200;
      }

      var contentWidth = windowWidth < __WEBPACK_IMPORTED_MODULE_0__settings__["a" /* settings */].widgetWidth ? '90%' : __WEBPACK_IMPORTED_MODULE_0__settings__["a" /* settings */].widgetWidth + 'px';
